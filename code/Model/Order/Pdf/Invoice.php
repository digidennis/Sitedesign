...
class Digidennis_Sitedesign_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Invoice
{
    /**
     * Return PDF document
     *
    ...
    public function getPdf($invoices = array())
    {
        ...
        $style->setFont(Zend_Pdf_Font::FONT_HELVETICA, 10);
        ...
        foreach ($invoices as $invoice) {
            ...
            $this->insertDocumentNumber(
                $page,
                Mage::helper('sales')->__('Fakturanummer: ') . $invoice->getIncrementId()
            );
            /* Add table */
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $this->setDocHeaderCoordinates(array(453.536, 600.93, 700, 600 - 55));
